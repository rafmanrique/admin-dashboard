                ...
                <div className="userShow">
                    ...
                    <div className="userShowBottom">
                        ...
                        <div className="userShowInfo">
                            ...
                            <span className="userShowInfoTitle">+1 254 875 60</span>
                        </div>
                        <div className="userShowInfo">
                ...
                <div className="userUpdate">
                    ...
                    <form className="userUpdateForm">
                        <div className="userUpdateLeft">
                            ...
                            <div className="userUpdateItem">
                                <label>Phone</label>
                                <input type="text" placeholder='+1 254 875 60' className='userUpdateInput' />
                            </div>
                            <div className="userUpdateItem">
                                <label>Address</label>
                                <input type="text" placeholder='Florida | USA' className='userUpdateInput' />
                            </div>
                        </div>
